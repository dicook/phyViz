...
#' @name sbTree
#' @title Soybean data
#' @description This data set contains soy bean phylogenetic information maintained by the United States Department of Agriculture to be used by plant breeders, genetecits, bioinformaticians, pathologists, ertomologists, and many other research workers.
#' @docType data

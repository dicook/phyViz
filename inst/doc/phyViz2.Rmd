...
\author{Lindsay Rutter$^{1,2*}$, Susan Vanderplas$^{1}$, Dianne Cook$^{1}$ \\[1em] \small{$^{1}$ Department of Statistics} \\ \small{$^{2}$ Bioinformatics and Computational Biology Program, Iowa State University, Ames, Iowa 50011, USA} \\ \small{\texttt{$^*$lrutter (at) iastate.edu}}}

\title{Phylogenetic visualization -- the phyViz package}
...
\begin{abstract}
   The **phyViz** package allows phylogeneticists to visualize and interpret their trees in multiple ways, each which come with their pros and cons. This vignette is intended to walk readers through the different options available with the package.

###  \vspace{1em}
  
###  \textbf{Dependency:} igraph must be used with version 0.7.0
...
%---------------------------------------------------
\section{Functions for Individual Vertices}
%---------------------------------------------------
...
%---------------------------------------------------
\section{Functions for Pairs of Vertices}
%---------------------------------------------------
...
%---------------------------------------------------
\section{Functions for All Vertices (Whole Tree)}
%---------------------------------------------------
...
%---------------------------------------------------
\section{Visualization of Pathway between Two Vertices}
%---------------------------------------------------
...
%---------------------------------------------------
\section{Visualization of Pathway between Two Vertices Superimposed on Tree}
%---------------------------------------------------
...
%---------------------------------------------------
\section{Generating Pairwise Distance Matrix between Set of Vertices}
%---------------------------------------------------

...
**Date:** Sep 23, 2014
-->
**Description:** The **phyViz** package allows phylogeneticists to visualize and interpret their trees in multiple ways, each which come with their pros and cons. This vignette is intended to walk you through the different options available to you with this package.
...
We can add the other data we have about each of the nodes in ig in several ways. The sbTree dataset contains information about each child; to add that data as is to the tree, we can use the following command: 
...
```{r}
getPath("Brim","Bedford", ig, isDirected=FALSE)
```

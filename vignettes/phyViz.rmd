...
As a side note, you could optionally write the **treeGraph** object into a .csv file that will be saved to your working directory, and could later be visualized in the software **Cytoscape**. However, we will not be covering this option in this vignette.
